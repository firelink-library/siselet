...
import portalCake from '../../../assets/arqui/paradigmas/portal_cake.jpg';
import vonNeumann from '../../../assets/arqui/paradigmas/von_neumann.jpg';
import moore from '../../../assets/arqui/paradigmas/moore.png';
import griffith from '../../../assets/arqui/paradigmas/griffith.jpg';
import mooreDead from '../../../assets/arqui/paradigmas/moore_dead.jpg';
import a64x2 from '../../../assets/arqui/paradigmas/a64x2.jpg';
import pentiumD from '../../../assets/arqui/paradigmas/pentium_d.jpg';
import sisd from '../../../assets/arqui/paradigmas/sisd.png';
import simd from '../../../assets/arqui/paradigmas/simd.png';
import misd from '../../../assets/arqui/paradigmas/misd.png';
import mimd from '../../../assets/arqui/paradigmas/mimd.png';
import memory from '../../../assets/arqui/paradigmas/memory.jpeg';
import umanuma from '../../../assets/arqui/paradigmas/umanuma.png';
...
<Image
    src={portalCake}
    alt="O bolo"
    style={{ height: '20%', height: 'auto' }}
/>
</center>
<p><center>O bolo.</center></p>
...
<p><center>Image Caption</center></p>
<p><center>A Lei de Moore no mundo real, com processadore da
...
<center>
  <Image
    src={mooreDead}
    alt="A lei de moore está morat"
    style={{ height: 'auto' }}
  />
</center>
<p><center>O fim da Lei de Moore "acontecendo" em vários momentos da
história.</center></p>
...
<p><center>Arquitetura simplificada do lendário Atlhon 64 x2, chip
...
<p><center>Enquanto isso, no lado azul tinhamos o Pentium D. Esse
...
<p><center>Uma arquitetura SISD é marcada por ter apenas um conjunto
...
<p><center>A arquitetura SIMD é marcada por continuar com um único
...
<p><center>A arquitetura MISD é menos usual. Nela, há apenas um
...
<p><center>A arquitetura MIMD é a mais versátil, mas também a mais
...
<p><center>Em a), temos um sistema cuja memória é compartilhada.
...
<br/>
<p><center>À esquerda, temos um sistema cujo acesso à memória é
